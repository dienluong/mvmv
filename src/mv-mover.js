...
function createMover() {
     ...
     * For any error, the Promise rejects to an array containing an Error for each failed move.
     * @param filesList {String[]} List of files to move
     * @param newFilesList {String[]} List of new names
     * @return {Promise}
     */
    function commitAsync(filesList, newFilesList) {
        let errorList = [];
        if (!Array.isArray(filesList) || !Array.isArray(newFilesList)) {
